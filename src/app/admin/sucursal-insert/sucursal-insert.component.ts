...
import { franquiciaService } from 'src/app/servicios/franquicia.service';
import {ErrorStateMatcher} from '@angular/material/core';
import { ReactiveFormsModule } from '@angular/forms';
import { MatCheckboxChange } from '@angular/material/checkbox';
import { gimnasio } from 'src/app/servicios/gimnasio';
...
@Component({
  selector: 'app-sucursal-insert',
  templateUrl: './sucursal-insert.component.html',
  styleUrls: ['./sucursal-insert.component.css']
})
export class SucursalInsertComponent implements OnInit {
