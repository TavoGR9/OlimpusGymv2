...
@Component({
  selector: 'app-sucursa-edit',
  templateUrl: './sucursa-edit.component.html',
  styleUrls: ['./sucursa-edit.component.css']
})
export class SucursaEditComponent implements OnInit {
